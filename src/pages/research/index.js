  ...
  return (
    <div className={classes.pageContainer}>
      <div className={classes.titleContainer}>
        <Title textContent='Research' fontSize='64' color='dark' wide='fit' textAlign='center' isUnderline />
      </div>
      ...
      <div className={classes.photoBtnContainer}>
        <div className={`${classes.photoBtn} ${classes.crabBtn}`} onClick={() => handleOnClick('/research/crab')}>
          <div className={classes.crabBtnTitle}>
            <Title textContent='Fiddler Crab' fontSize='48' color='dark' wide='fit' textAlign='center' isUnderline={false} />
          </div>
        </div>
        ...
        <div className={`${classes.photoBtn} ${classes.magpieBtn}`} onClick={() => handleOnClick('/research/magpie')}>
          <div className={classes.magpieBtnTitle}>
            <Title textContent='Taiwan Blue Magpie' fontSize='48' color='dark' wide='fit' textAlign='center' isUnderline={false} />
          </div>
        </div>
      </div>
    </div>
